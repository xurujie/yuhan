...
public class MD5Tool {
    ...
    public static void main(String[] args) {
        try {
            String value = "{{{DEQ{PHJCXJKBSQKJSHNQP:KOIJDPJOPIJUEOPIKEPOSPS";
            String key = "yuhankeji";// 自定义密钥,个数不能太短，太短报错，过长，它默认只取前N位（N的具体值，大家另行查找资料）
    ...
    public static String getSign(String appid,String body,String mch_id,String nonce_str ,String notify_url,String openid,String out_trade_no,String spbill_create_ip,String total_fee,String trade_type){
        String s = "appid="+appid+"&body="+body+"&mch_id="+mch_id+"&nonce_str="+nonce_str+"&notify_url="+notify_url+"&openid="+openid+"&out_trade_no"+out_trade_no+"&spbill_create_ip="+spbill_create_ip
