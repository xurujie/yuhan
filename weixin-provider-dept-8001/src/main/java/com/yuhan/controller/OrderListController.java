...
public class OrderListController {
	...
	public String balongsList(HttpServletRequest req){
	   ...
	   sb.append(orderListService.findByUserId(userInformation.getId()));
	...
	public String balongsListGet1(HttpServletRequest req){
		sb=new StringBuffer();
		UserInformation userInformation = (UserInformation)req.getSession().getAttribute("user");
		if(userInformation==null){
			sb.append("{\"result\":\"0000\",\"msg\":\"Success\",\"data\":{\"status\":\"0\"},\"sign\":\""+ DateUtil.formate0(new Date(), "yyyy-MM-dd   HH:mm:ss")+"\"}");
		...
		List<OrderListShow> olss = orderListService.findByUserIdAndStatus(userInformation.getId(), "1");
		if(olss!=null){
		sb.append(olss);
		}
		sb.append("},\"sign\":\""+DateUtil.formate0(new Date(), "yyyy-MM-dd	HH:mm:ss")+"\"}");
	...
	public String balongsListGet2(HttpServletRequest req){
		sb=new StringBuffer();
		UserInformation userInformation = (UserInformation)req.getSession().getAttribute("user");
		if(userInformation==null){
			sb.append("{\"result\":\"0000\",\"msg\":\"Success\",\"data\":{\"status\":\"0\"},\"sign\":\""+ DateUtil.formate0(new Date(), "yyyy-MM-dd   HH:mm:ss")+"\"}");
		...
		List<OrderListShow> olss = orderListService.findByUserIdAndStatus(userInformation.getId(), "2");
		if(olss!=null){
		sb.append(olss);
		}
		sb.append("},\"sign\":\""+DateUtil.formate0(new Date(), "yyyy-MM-dd	HH:mm:ss")+"\"}");
	...
	public String balongsListGet3(HttpServletRequest req){
		sb=new StringBuffer();
		UserInformation userInformation = (UserInformation)req.getSession().getAttribute("user");
		if(userInformation==null){
			sb.append("{\"result\":\"0000\",\"msg\":\"Success\",\"data\":{\"status\":\"0\"},\"sign\":\""+ DateUtil.formate0(new Date(), "yyyy-MM-dd   HH:mm:ss")+"\"}");
		...
		List<OrderListShow> olss = orderListService.findByUserIdAndStatus(userInformation.getId(), "3");
		if(olss!=null){
		sb.append(olss);
		}
		sb.append("},\"sign\":\""+DateUtil.formate0(new Date(), "yyyy-MM-dd	HH:mm:ss")+"\"}");
	...
	public String balongsListGet4(HttpServletRequest req){
		sb=new StringBuffer();
		UserInformation userInformation = (UserInformation)req.getSession().getAttribute("user");
		if(userInformation==null){
			sb.append("{\"result\":\"0000\",\"msg\":\"Success\",\"data\":{\"status\":\"0\"},\"sign\":\""+ DateUtil.formate0(new Date(), "yyyy-MM-dd   HH:mm:ss")+"\"}");
		...
		List<OrderListShow> olss = orderListService.findByUserIdAndStatus(userInformation.getId(), "4");
		if(olss!=null){
		sb.append(olss);
		}
		sb.append("},\"sign\":\""+DateUtil.formate0(new Date(), "yyyy-MM-dd	HH:mm:ss")+"\"}");
