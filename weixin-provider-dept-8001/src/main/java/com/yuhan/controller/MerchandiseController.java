...
public String balongsList(HttpServletRequest req){
	...
	public String recommendMerchandiseType(HttpServletRequest req){
		...
		List<MerchandiseShow>  mss= merchandiseShowService.findByRecommendType(type,Integer.parseInt(pageNumber),Integer.parseInt(pageSize));
	...
	public String balongsType(HttpServletRequest req){
		String type = req.getParameter("type");
		String pageNumebe = req.getParameter("pageNumber");
		String pageSize = req.getParameter("pageSize");
		sb = new StringBuffer();
		sb.append("{\"result\":\"1004\",\"msg\":\"Success\",\"data\":{");
		List<MerchandiseShow>  mss= merchandiseShowService.findByTypePaging(type,Integer.parseInt(pageNumebe),Integer.parseInt(pageSize));
		System.out.println(mss);
		sb.append("\"ListArray\":[");
		for(MerchandiseShow merchandiseShow:mss){
			sb.append(merchandiseShow);
