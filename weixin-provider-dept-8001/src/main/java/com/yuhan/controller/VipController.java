    ...
    public void getOpenId(HttpServletRequest request,
      ...
      /*response.setContentType("text/html");
        ...
        String result = NoteUtil.httpRequestToString(
                "https://api.weixin.qq.com/sns/jscode2session?appid=wx7c5b20758cd2fea5&secret=e008aa6fcf7c4694e2457a78b52f7182&js_code="+code+"&grant_type=authorization_code", params);
...
System.out.println(jsonObject);
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        ...
        vipController.getOpenId(null,null,"043pk5O612SA8N1pp3N61KHfO61pk5Ob");
    }
}
