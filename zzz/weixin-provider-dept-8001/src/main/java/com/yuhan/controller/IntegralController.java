...
public class IntegralController {
    ...
    public String integralList(HttpServletRequest req) {
       ...
       String s2=req.getParameter("end");
        sb = new StringBuffer();
        sb.append("{\"result\":\"1001\",\"msg\":\"Success\",\"data\":{");
     List<Integral>  integrals = integralService.findBy(Integer.parseInt(s1),Integer.parseInt(s2));
     for(Integral integral : integrals){
        ...
        sb.append("\"merchandiseShow\":"+merchandiseShow+"},");
     }
